  ...
  function journey() {
    ...
    yTicks.forEach(function (t) {
      svg.append("line").attr("x1", m.l).attr("x2", W - m.r).attr("y1", y(t)).attr("y2", y(t))
        .attr("stroke", t === 0 ? C.gray : C.line).attr("stroke-width", t === 0 ? 1.2 : 1);
    });
    // 세로 그리드 실선 (단계별)
    ...
    svg.append("line").attr("x1", m.l).attr("x2", m.l).attr("y1", m.t).attr("y2", H - m.b)
      .attr("stroke", C.ink3).attr("stroke-width", 1.4);
