...
| - | Figma 프로토타입 | 🔄 진행중 | - |
| - | 발표 자료 | ✅ 완료 | `presentation/` — 20분 발표 deck 45장 (목차·챕터 간지·페르소나 포함, LSB 공식 통계 반영) |
| - | 최종 발표 | 📌 확정 | 2026-06-19 |
...
>
> 🇱🇦 **LSB 공식 통계의 deck 반영**: 수집한 라오스 공식 통계를 발표 슬라이드 3곳에 근거로 삽입.
> - **PEST(기술·경제)**: 전기 보급률 96.5% · 전력 잉여(수출 40.8 / 수입 0.6 TWh) · 주택 ~647₭/kWh → 충전 원가 우위 (충전 4,300₭ ≈ 265원)
> - **TAM-SAM-SOM(`왜 지금인가`)**: 비엔티안·사반나켓 **양대 거점**(가구 18.8/18.6만 집중) = SOM 1차 타깃
> - **고객 페르소나(EV 차량 오너)**: **15~39세 43.2%** 젊은 얼리어답터 연령 구조
...
| 인구·가구·연령 | 비엔티안 인구 **102.9만(13.5%)** · 가구 **18.8만 ≈ Savannakhet 18.6만** · **15~39세 43.2%** | SOM **양대 거점**(deck TAM-SAM-SOM) + **얼리어답터 연령**(deck 페르소나) — LSB 1차 |
